...
4. ~~**geNomad adoption**~~ — **RESOLVED 2026-07-21**, see §3.1. geNomad is the new default phage caller (VirSorter2 selectable, not removed) and a 2nd-opinion plasmid caller beside Platon. Details and sourcing: `docs/unification_migration_plan.md` §4 D8/D9.
